      ...
      <Container className="h-16 flex items-center justify-between">
        ...
        <NavigationMenu className="hidden md:flex">
          <NavigationMenuList>
            ...
            <NavigationMenuItem>
              <Link href="/docs/seo-metrics" legacyBehavior passHref>
                <NavigationMenuLink>SEO Metrics</NavigationMenuLink>
              </Link>
            </NavigationMenuItem>
          </NavigationMenuList>
        </NavigationMenu>
        ...
        <Sheet>
          ...
          <SheetContent>
            ...
            <div className="flex flex-col space-y-4 mt-4 px-4">
              ...
              <Link href="/docs/seo-metrics" className="text-sm font-medium">
                SEO Metrics
              </Link>
