              ...
              <div className="bg-card p-8 rounded-2xl shadow-xl">
                <div className="space-y-6">
                  <div className="flex items-center gap-4 flex-col md:flex-row">
                    <div className="min-w-12 min-h-12 rounded-full bg-primary/10 flex items-center justify-center">
                      <FileCode className="w-6 h-6 text-primary" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-lg">
                        Generate a LLMs.txt file for your website
                      </h3>
                      <p className="text-sm text-foreground/80">
                        Just input your homepage URL and we will do the rest,
                  ...
                  <ul className="list-disc space-y-2 text-sm">
                    <li className="flex justify-between">
                      ...
                      <span className="text-sm font-medium text-green-700 dark:text-green-500 text-right">
                        ~3 minutes
                      </span>
                    </li>
                    <li className="flex justify-between">
                      <span>Content Analysis and Understanding</span>
                      <span className="text-right text-sm font-medium text-blue-700 dark:text-blue-500">
                        ~4 minutes
                      </span>
                    </li>
                    <li className="flex justify-between">
                      <span>Downloadable LLMs.txt file ready</span>
                      <span className="text-sm text-right font-medium text-purple-700 dark:text-purple-500">
                        7 to 10 minutes
                      </span>
                    </li>
                  </ul>
        ...
        <Container>
          ...
          <div className="max-w-4xl mx-auto dark:bg-card bg-background p-8 rounded-lg">
            ...
            <p className="text-lg text-foreground/80 mb-6">
              ...
              ChatGPT and Claude to find information, this file is becoming your
              new digital front door.
            </p>
            <Link
              href="/blog/what-is-llms-txt"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="bg-card p-6 rounded-lg">
              <div className="flex items-start">
                <span className="bg-primary min-h-8 min-w-8 h-8 w-8 flex items-center justify-center text-black p-1 rounded-full mr-3 mt-1">
                  ✓
                </span>
                <div>
            ...
            <div className="bg-card p-6 rounded-lg">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-foreground/80">
                    Early adopters will have an edge as AI search grows
                    (remember early SEO winners?)
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card p-6 rounded-lg">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-foreground/80">
                    Stop AI from quoting outdated info or missing your key
                    points
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-card p-8 rounded-lg">
              <ol className="space-y-6">
                <li className="flex">
                  <div className="bg-primary text-black min-h-8 min-w-8 h-8 w-8 flex items-center justify-center rounded-full font-bold mr-4 flex-shrink-0">
                    1
                  </div>
                  <div>
                    <h3 className="text-xl font-bold">Deep crawling</h3>
                    <p className="text-foreground/80">
                      We analyze your homepage and key pages
                    </p>
                  </div>
                </li>
                <li className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80">
                      Content is transformed for optimal AI ingestion
                    </p>
                  </div>
                </li>
                <li className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80">
                      Our proprietary system identifies:
                    </p>
                ...
                <li className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80">
                      We highlight what makes your site unique
                    </p>
                  </div>
                </li>
                <li className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80">
                      Get a perfectly formatted LLMs.txt file ready to implement
                    </p>
                  </div>
                </li>
              </ol>
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="dark:bg-card bg-background p-6 rounded-lg hover:translate-y-[-5px] transition-all">
              <span className="bg-primary min-h-8 min-w-8 h-8 w-8 flex items-center justify-center text-black p-1 rounded-full mb-4">
                ✓
              </span>
            ...
            <div className="dark:bg-card bg-background p-6 rounded-lg hover:translate-y-[-5px] transition-all">
              ...
              <p className="text-foreground/80">
                Highlights concepts and entities, not just URLs
              </p>
            </div>
            ...
            <div className="dark:bg-card bg-background p-6 rounded-lg hover:translate-y-[-5px] transition-all">
              ...
              <p className="text-foreground/80">
                Surfaces what makes your business unique
              </p>
            </div>
            ...
            <div className="dark:bg-card bg-background p-6 rounded-lg hover:translate-y-[-5px] transition-all">
              ...
              <p className="text-foreground/80">
                Ready for evolving AI standards
              </p>
            </div>
        ...
        <Container>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-card  p-8 rounded-lg">
              <ol className="space-y-6">
                <li className="flex">
                  <div className="bg-primary min-h-8 min-w-8 h-8 w-8 flex items-center justify-center text-black p-1 rounded-full font-bold mr-4 flex-shrink-0">
                    1
                  </div>
                  <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="bg-card p-6 rounded-lg">
              ...
              <p className="text-lg text-foreground/80">
                A perfectly formatted LLMs.txt file
              </p>
            </div>
            ...
            <div className="bg-card p-6 rounded-lg">
              ...
              <p className="text-lg text-foreground/80">
                Optimized hierarchy of your most important content
              </p>
            </div>
            ...
            <div className="bg-card p-6 rounded-lg">
              ...
              <p className="text-lg text-foreground/80">
                Clear descriptions that help AI understand your offerings
              </p>
            </div>
            ...
            <div className="bg-card p-6 rounded-lg">
              ...
              <p className="text-lg text-foreground/80">
                Proper markdown syntax following emerging standards
              </p>
            </div>
            ...
            <div className="bg-card p-6 rounded-lg">
              ...
              <p className="text-lg text-foreground/80">
                A competitive edge in AI-powered search and discovery
              </p>
            </div>
          </div>
        </Container>
      ...
      <section className="py-16 bg-gradient-to-r from-primary to-primary">
        <Container>
          ...
          <p className="text-lg text-primary-foreground/80 max-w-3xl mx-auto mb-8">
            Process takes approximately 10 minutes. You can continue browsing
            while we work.
          </p>
