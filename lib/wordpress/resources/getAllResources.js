...
export async function GET_RESOURCES(perPage = 100, offset = 0) {
  ...
  `);
    ...
    if (data.resources.edges[0].node.resourceTypes.edges[0].node.name === "guides") {
      resources.guides.push(data.resources.edges[0].node);
    } else if (data.resources.edges[0].node.resourceTypes.edges[0].node.name === "spreadsheets") {
      resources.spreadsheets.push(data.resources.edges[0].node);
    } else if (data.resources.edges[0].node.resourceTypes.edges[0].node.name === "ebooks") {
