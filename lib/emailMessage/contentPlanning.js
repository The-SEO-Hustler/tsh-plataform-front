function contentPlanningEmailMessage(keyword, id) {
  return `
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🎯 Content Planning Completed!</h1>
        </div>
        <div class="content">
            <p>Great news! Your content planning has been completed successfully.</p>
            ...
            <p>Your comprehensive content planning is now ready with detailed insights on:</p>
            <ul>
            ...
            <div style="text-align: center;">
                <a href="https://theseohustler.com/content-planning/result?id=${id}" class="cta-button">
...
module.exports = { contentPlanningEmailMessage }; 