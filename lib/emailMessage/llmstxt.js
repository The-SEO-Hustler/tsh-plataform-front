function llmstxtEmailMessage(url, id) {
  return `
              <!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🎯 LLMs.txt Generation Completed!</h1>
        </div>
        <div class="content">
            <p>Great news! Your LLMs.txt generation has been completed successfully.</p>
            ...
            <p>Your comprehensive LLMs.txt generation is now ready with detailed insights on:</p>
            <ul>
            ...
            <div style="text-align: center;">
                <a href="https://theseohustler.com/llmstxt/result?id=${id}" class="cta-button">
...
module.exports = { llmstxtEmailMessage };