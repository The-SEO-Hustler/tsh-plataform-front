function searchQualityEvaluatorEmailMessage(landingPageURL, id) {
  return `
              <!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🎯 Search Quality Evaluator Completed!</h1>
        </div>
        <div class="content">
            ...
            <p>Your comprehensive search quality evaluation is now ready with detailed insights on:</p>
            <ul>
            ...
            <div style="text-align: center;">
                <a href="https://theseohustler.com/eeat-checker/result?id=${id}" class="cta-button">
...
module.exports = { searchQualityEvaluatorEmailMessage };  