function advancedKeywordAnalysisEmailMessage(keyword, id) {
  return `
           <!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🎯 Advanced Keyword Analysis Completed!</h1>
        </div>
        <div class="content">
            <p>Great news! Your advanced keyword analysis has been completed successfully.</p>
            ...
            <p>Your comprehensive advanced keyword analysis is now ready with detailed insights on:</p>
            <ul>
                <li>🔍 Search Intent</li>
            ...
            <div style="text-align: center;">
                <a href="https://theseohustler.com/advanced-keyword-analysis/result?id=${id}" class="cta-button">
...
module.exports = { advancedKeywordAnalysisEmailMessage };